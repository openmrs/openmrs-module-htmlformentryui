...
public class ViewEncounterWithHtmlFormFragmentController extends BaseHtmlFormFragmentController {
	...
	public void controller(@SpringBean("htmlFormEntryService") HtmlFormEntryService htmlFormEntryService,
	        ...
	        @SpringBean EmrApiProperties emrApiProperties, @SpringBean DispositionService dispositionService,
	        @SpringBean FeatureToggleProperties featureToggleProperties, @FragmentParam("encounter") Encounter encounter,
	...
	public SimpleObject getAsHtml(@SpringBean("htmlFormEntryService") HtmlFormEntryService htmlFormEntryService,
	        ...
	        @SpringBean("coreResourceFactory") ResourceFactory resourceFactory,
	        @SpringBean EmrApiProperties emrApiProperties, @SpringBean DispositionService dispositionService,
	        @SpringBean FeatureToggleProperties featureToggleProperties, @RequestParam("encounterId") Encounter encounter,
	...
	private FormEntrySession getFormEntrySession(HtmlFormEntryService htmlFormEntryService, FormService formService,
	        ResourceFactory resourceFactory, Encounter encounter, HtmlForm hf, String definitionUiResource, UiUtils ui,
	        UiSessionContext sessionContext, HttpSession httpSession, VisitDomainWrapper visitDomainWrapper,
	        FeatureToggleProperties featureToggleProperties) throws Exception {
		if (hf == null) {
