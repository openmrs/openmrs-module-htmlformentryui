...
public class EnterHtmlFormFragmentControllerComponentTest extends BaseModuleWebContextSensitiveTest {
	...
	public void testDefiningAnHtmlFormInUiResource() throws Exception {
		...
		controller.controller(config, sessionContext, ui, htmlFormEntryService, adtService, formService, resourceFactory,
		    featureToggles, patient, null, null, null, null, resourcePath, null, null, null, null, null, true, model, null);
